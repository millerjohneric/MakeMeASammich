...
sidebar_label: Apple Pie Moonshine
...
**Instructions:**
1. Combine all ingredients listed above in a large pot.
2. Bring to a boil, then remove from heat.
3. Let the mixture cool completely to room temperature.

**After Cooling:**
- Stir in ½ liter Everclear.

**Final Steps:**
1. Place one of the cooked cinnamon sticks into each mason jar.
2. (Optional) Strain through cheesecloth to remove sediment.
